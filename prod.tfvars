...
# # Prod App Networking
app_vnet_address_space              = ["10.20.3.0/24"]
app_cmp_subnet_address_prefixes     = ["10.20.3.0/26"]
app_pvtlink_subnet_address_prefixes = ["10.20.3.64/26"]
